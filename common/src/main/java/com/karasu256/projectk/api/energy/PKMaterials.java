...
public enum PKMaterials {
    ...
    GOD("god", 0xFFD700, "God", "神", ProjectKEnergies.EnergyKind.NEUTRAL),
    EXTREME("extreme", AbyssEnergyColor.EXTREME.getRGB(), "Extreme", "極", ProjectKEnergies.EnergyKind.NEUTRAL),
    EVIL("evil", AbyssEnergyColor.EVIL.getRGB(), "Evil", "悪", ProjectKEnergies.EnergyKind.NEUTRAL),
    HEAT("heat", AbyssEnergyColor.HEAT.getRGB(), "Heat", "熱", ProjectKEnergies.EnergyKind.NEUTRAL),
    COLD("cold", AbyssEnergyColor.COLD.getRGB(), "Cold", "冷", ProjectKEnergies.EnergyKind.NEUTRAL),
    LOVE("love", AbyssEnergyColor.LOVE.getRGB(), "Love", "愛", ProjectKEnergies.EnergyKind.NEUTRAL);
