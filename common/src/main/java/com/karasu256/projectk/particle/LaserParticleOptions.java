...
public record LaserParticleOptions(ResourceLocation energyId, Vec3 target, double scale,
    ...
    public static final MapCodec<LaserParticleOptions> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ResourceLocation.CODEC.optionalFieldOf("energy_id",
                            ProjectKEnergies.getEnergyIdByKind(ProjectKEnergies.EnergyKind.NEUTRAL))
                    .forGetter(LaserParticleOptions::energyId),
