...
public class ProjectKBlockEntities implements IKRegistryInitializerTarget {
    ...
    public static final RegistrySupplier<BlockEntityType<AbyssChargerBlockEntity>> ABYSS_CHARGER = blockEntity("abyss_charger", () -> BlockEntityType.Builder.of(AbyssChargerBlockEntity::new, ProjectKBlocks.ABYSS_CHARGER.get()).build(null));
    ...
    public static final RegistrySupplier<BlockEntityType<AbyssEnchantRemoverBlockEntity>> ABYSS_ENCHANT_REMOVER = blockEntity("abyss_enchant_remover", () -> BlockEntityType.Builder.of(AbyssEnchantRemoverBlockEntity::new, ProjectKBlocks.ABYSS_ENCHANT_REMOVER.get()).build(null));
