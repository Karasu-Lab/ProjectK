...
public class JaJpLanguage implements ProjectKLanguage {
    ...
    public void addCommon(TranslationAdder adder) {
        ...
        adder.add(ProjectKBlocks.ABYSS_GENERATOR, "深淵発電機");
        adder.add(ProjectKBlocks.ABYSS_MAGIC_TABLE, "深淵魔術テーブル");
        adder.add(ProjectKBlocks.ABYSS_ALCHEMY_BLEND_MACHINE, "深淵錬金合成機");
        adder.add(ProjectKBlocks.ABYSS_ENCHANTER, "深淵エンチャンター");
        adder.add(ProjectKBlocks.ABYSS_CHARGER, "深淵チャージャー");
        adder.add(ProjectKBlocks.ABYSS_STORAGE, "深淵貯蔵機");
        adder.add(ProjectKBlocks.CREATIVE_ABYSS_STORAGE, "クリエイティブ深淵貯蔵機");
        adder.add(ProjectKBlocks.ABYSS_ENERGY_CABLE, "深淵エネルギーケーブル");
        adder.add(ProjectKBlocks.ABYSS_SYNTHESIZER, "深淵合成機");
        adder.add(ProjectKBlocks.ABYSS_LASER_EMITTER, "深淵レーザー発射機");
        adder.add(ProjectKBlocks.ABYSS_ABSORPTION_PRISM, "深淵吸収プリズム");
        adder.add(ProjectKBlocks.ABYSS_PORTAL, "深淵ポータル");
        adder.add(ProjectKBlocks.POLISHED_NETHERRACK, "磨かれたネザーラック");
        adder.add(ProjectKBlocks.POLISHED_GLOWSTONE, "磨かれたグロウストーン");
        adder.add(ProjectKBlocks.KARASIUM_ORE, "カラシウム鉱石");
        adder.add(ProjectKBlocks.DEEPSLATE_KARASIUM_ORE, "深層カラシウム鉱石");
        adder.add(ProjectKBlocks.ABYSS_ENCHANT_REMOVER, "深淵エンチャントリムーバー");

        adder.add(ProjectKBlocks.ABYSS_CORE, "深淵コア");

        adder.add(ProjectKItems.WITHER_BONE, "ウィザーの骨");
        adder.add(ProjectKItems.KARASIUM, "カラシウム");
        adder.add(ProjectKItems.RAW_KARASIUM, "カラシウム原石");
        adder.add(ProjectKItems.KARASIUM_DUST, "カラシウムダスト");
        adder.add(ProjectKItems.ABYSS_INGOT, "深淵インゴット");
        adder.add(ProjectKItems.TIER_UPGRADE, "ティアアップグレード");
        adder.add(ProjectKItems.ABYSS_BRACELET, "深淵ブレスレット");
        adder.add(ProjectKItems.ABYSS_STAFF, "深淵の杖");
        adder.add(ProjectKItems.ABYSS_ABSORPTION_PRISM_SHARD, "深淵吸収プリズムの欠片");
