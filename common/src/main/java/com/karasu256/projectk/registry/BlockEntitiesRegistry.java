...
public class BlockEntitiesRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<KGeneratorBlockEntity>> K_GENERATOR = BLOCK_ENTITIES.register(Id.id("k_generator"), () -> BlockEntityType.Builder.of(KGeneratorBlockEntity::new, ProjectKBlocks.K_GENERATOR.get()).build(null));
